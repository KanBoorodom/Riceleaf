    ...
    if showDetected and detectedDict:  
        ...
        with st.container():
            ...
            with st.expander('เชื้อไวรัส'):
                ...
                #TODO โรคขอบใบหงิก ---------------------------
                with tab1m:
                    tab1n,tab2n,tab3n,tab4n= st.tabs(['สาเหตุของโรคและภูมิภาคที่พบ','อาการของโรค','การแพร่ระบาด','การป้องกัน'])
                    with tab1n:  
                ...
                #TODO โรคเขียวเตี้ย ---------------------------
                with tab2m:
                    tab1o,tab2o,tab3o,tab4o= st.tabs(['สาเหตุของโรคและภูมิภาคที่พบ','อาการของโรค','การแพร่ระบาด','การป้องกัน'])
                    with tab1o:  
                ...
                #TODO โรคใบสีส้ม ---------------------------
                with tab3m:
                    tab1p,tab2p,tab3p,tab4p= st.tabs(['สาเหตุของโรคและภูมิภาคที่พบ','อาการของโรค','การแพร่ระบาด','การป้องกัน'])
                    with tab1p:  
                ...
                #TODO โรคหูด ---------------------------
                with tab4m:
                    tab1q,tab2q,tab3q,tab4q= st.tabs(['สาเหตุของโรคและภูมิภาคที่พบ','อาการของโรค','การแพร่ระบาด','การป้องกัน'])
                    with tab1q:  
            ...
            with st.expander('ไฟโตพลาสมา'):
                ...
                #TODO โรคสีแสด ---------------------------
                with tab1r:
                    tab1s,tab2s,tab3s,tab4s= st.tabs(['สาเหตุของโรคและภูมิภาคที่พบ','อาการของโรค','การแพร่ระบาด','การป้องกัน'])
                    with tab1s:  
                ...
                #TODO โรคเหลืองเตี้ย ---------------------------
                with tab2r:
                    tab1t,tab2t,tab3t,tab4t= st.tabs(['สาเหตุของโรคและภูมิภาคที่พบ','อาการของโรค','การแพร่ระบาด','การป้องกัน'])
                    with tab1t:  
            ...
            with st.expander('ไส้เดือนฝอย'):
                ...
                #TODO โรครากปม ---------------------------
                tab1u,tab2u,tab3u,tab4u= st.tabs(['สาเหตุของโรคและภูมิภาคที่พบ','อาการของโรค','การแพร่ระบาด','การป้องกัน'])
                with tab1u:  
            ...
            with st.expander('สารพิษในดิน'):
                ...
                #TODO โรคเมาตอซัง ---------------------------
                tab1w,tab2w,tab3w,tab4w= st.tabs(['สาเหตุของโรคและภูมิภาคที่พบ','อาการของโรค','การแพร่ระบาด','การป้องกัน'])
                with tab1w:  
            ...
            with st.expander('ไม่ทราบสาเหตุ'):
                ...
                #TODO โรคใบแถบแดง ---------------------------
                tab1v,tab2v,tab3v,tab4v= st.tabs(['สาเหตุของโรคและภูมิภาคที่พบ','อาการของโรค','การแพร่ระบาด','การป้องกัน'])
                with tab1v:  
