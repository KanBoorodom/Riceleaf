                    ...
                    with st.expander(f'ตรวจพบโรคไหม้ทั้งหมด: {detectedDict[0]} ตำแหน่ง',True):
                        ...
                        with tab1:
                            st.markdown('<h5 class="tab-subhead">ระยะกล้า</h5> \
                                    ...
                                    <h5>ระยะออกรวง</h5> \
                                    <p class="tab-subhead">ถ้าข้าวเพิ่งจะเริ่มให้รวงเมื่อถูกเชื้อราเข้าทำลายเมล็ดจะลีบหมด แต่ถ้าเป็นโรคตอนรวงข้าวแก่ใกล้เก็บเกี่ยวจะปรากฏรอยแผลช้ำสีน้ำตาลที่บริเวณคอรวงทำให้เปราะหักง่ายรวงข้าวร่วงหล่นเสียหายมาก</p> '
                                ,unsafe_allow_html=True
                            )
